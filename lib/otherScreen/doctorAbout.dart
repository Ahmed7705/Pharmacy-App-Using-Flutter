...
class DoctorAbout extends StatelessWidget {
  ...
  DoctorAbout({required this.docEmail, required this.docName});
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          Icon(Icons.stars, size: height * 0.03, color: Colors.red,),
                      ...
                      Row(
                        children: <Widget>[
                          Icon(Icons.email, size: height * 0.03, color: Colors.green),
                          SizedBox(width: width * 0.02,),
                          Text(
                            docEmail,
                            style: GoogleFonts.abel(fontSize: height * 0.025),
