...
class FavoritPage extends StatefulWidget {
  ...
  FavoritPage({Key? key, this.scaffoldKey ,required this.detailsUser}) : super(key: key);

  @override
  _ProductsPageState createState() => _ProductsPageState();
}

class _ProductsPageState extends State<FavoritPage> {
  ...
  Future getDiseaseInfo() async {
    ...
    qn = await firestore.where('favorite',isNotEqualTo:false).get();
    var mmm = qn?.docs;
