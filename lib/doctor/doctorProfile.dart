...
class _DoctorProfileState extends State<DoctorProfile> {
  ...
  profileUpdate() {
    ...
    Toast.show('Profile Updated!', backgroundColor: Colors.blue, backgroundRadius: 5,
        duration: 2);
  }
                ...
                child: Column(
                  children: <Widget>[
                    Hero(
                      ...
                      child: CircleAvatar(
                        radius: height * 0.05,
                        backgroundImage: NetworkImage(widget.doctorDetails.photoUrl.toString()),
                      ),
                    ),
                    SizedBox(
                      height: height * 0.03,
                    ...
                    Text(
                      'Dr. ' + widget.doctorDetails.userName.toString(),
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 24),
                    ),
                    SizedBox(height: height * 0.007),
                    Text(
                      "Email: " + widget.doctorDetails.userEmail.toString(),
                      style: TextStyle(
                                      ...
                                      children: <Widget>[
                                        FloatingActionButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            Toast.show('Empty Field Found!', backgroundColor: Colors.red, backgroundRadius: 5, duration: 3);
                                          },
                                          child: WidgetAnimator(
                                            Icon(
                                              Icons.done,
