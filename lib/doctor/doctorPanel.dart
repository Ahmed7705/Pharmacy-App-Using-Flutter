...
class DoctorPanel extends StatefulWidget {
  ...
  // DoctorDetails detailsUser=DoctorDetails('Ahmed Mohsen Alhdadi','Ahmed',
  //     'https://t4.ftcdn.net/jpg/02/60/04/09/360_F_260040900_oO6YW1sHTnKxby4GcjCvtypUCWjnQRg5.jpg','mm770545327@gmail.com');
                                  ...
                                  Navigator.push(
                                      ...
                                      new MaterialPageRoute(
                                          builder: (context) => TabsExample(
                                            doctorName:
                                            widget.detailsUser.userName.toString(),
                                            doctorEmail: widget.detailsUser.userEmail.toString(),
                                          )));
                                },
                              ),
                            ),
